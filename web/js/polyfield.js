  ...
  Polyfield = function () {
    var Polyfield = function () {
      ...
      _createClass(Polyfield, [{
        ...
        value: function generateDropdown(id, modelName, attribute, counter, label, values, selected, filterAttr, sortAttr, attributePrefix, valueAttribute, exists) {
          var _this2 = this;
          ...
          if (filterAttr) {
            ...
            filterSelect.appendChild(this.generateOptions(_filterValues, attribute, null, sortAttr, attributePrefix, valueAttribute));
            ...
            jQuery(filterSelect).on('change', function () {
              ...
              return select.appendChild(_this2.generateOptions(filteredValues, attribute, selected, sortAttr, attributePrefix, valueAttribute));
            });
          }
        ...
        value: function orderOptions(counter) {
          ...
          for (i = j = 1, ref = counter; undefined !== 0 && (1 <= ref ? 1 <= j && j <= ref : 1 >= j && j >= ref); i = 1 <= ref ? ++j : --j) {
            option = document.createElement('option');
            if (i === counter) {
        ...
        value: function updateOrder(classSelector, counter) {
          ...
          $selects.each(function () {
            ...
            if (optLen < counter) {
              results = [];
              for (i = j = ref = optLen + 1, ref1 = counter; undefined !== 0 && (ref <= ref1 ? ref <= j && j <= ref1 : ref >= j && j >= ref1); i = ref <= ref1 ? ++j : --j) {
